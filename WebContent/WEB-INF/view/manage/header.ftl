<head>
    ...
    <link rel="stylesheet" href="${rc.contextPath}/static/upload/css/jquery.fileupload.css">
	<link rel="stylesheet" href="${rc.contextPath}/static/upload/css/jquery.fileupload-ui.css">
	<link rel="stylesheet" href="${rc.contextPath}/static/date/css/bootstrap-datetimepicker.min.css">
    <link rel="stylesheet" type="text/css" href="${rc.contextPath}/static/datatables/css/datatables.min.css"/>
